...
shap.read_data(start,end,step,\
               file='/media/nils/Elements/P125_21pi_vu_Q-structure_SHAP_cf/P125_21pi_vu',
               fileQ='/data2/cremades/P125_21pi_vu_Q_divide/P125_21pi_vu',
               fileuvw='/data/cremades/P125_21pi_vu/P125_21pi_vu',
               absolute=True,readdata=True,fileread='data_plots_wall_cf.h5.Q')
...
shap.plot_shaps_pdf(colormap='viridis',bin_num=70,lev_val=2,structures=['streak', 'chong', 'streak_high_vel'], mode=mode) #lev_val=5.1
...
# shap.plot_shaps_pdf_wall(colormap='viridis',bin_num=70,lev_val=2, structures=['streak', 'chong'], mode=mode)
# shap.plot_shaps_uv(colormap='viridis')
# shap.plot_shaps_uv_ejectionover(colormap='viridis')
# shap.plot_shaps_uv_pdf(colormap='viridis',bin_num=70,lev_val=2, structures=['streak', 'chong'], mode=mode, switch='vv') #lev_val=5.1
# shap.plot_shaps_k_pdf(colormap='viridis', bin_num=70,lev_val=2, structures=['streak', 'chong'], mode=mode)
shap.plot_shaps_ens_pdf(colormap='viridis',bin_num=70,lev_val=2,structures=['streak', 'chong', 'streak_high_vel'], mode=mode)
...
# shap.plot_shaps_x_pdf_wall(colormap='viridis',bin_num=70,lev_val=2, x='uv', structures=['streak', 'chong'], mode=mode)
# shap.plot_shaps_x_pdf_wall(colormap='viridis',bin_num=70,lev_val=2, x='k', structures=['streak', 'chong'], mode=mode)
# shap.plot_shaps_x_pdf_wall(colormap='viridis',bin_num=70,lev_val=2, x='ens', structures=['streak', 'chong'], mode=mode)
