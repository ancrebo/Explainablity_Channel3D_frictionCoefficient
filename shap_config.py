...
class shap_conf():
    ...
    def predict_frozen(self, input_field):
        ...
        predictions = self.frozen_func(x=tf.constant(input_field, dtype=tf.int32))
    ...
    def plot_shaps(self,colormap='viridis'):
        ...
        plt.savefig('vol_SHAP_'+colormap+'_30+.png')
        fig = plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_yticklabels(['Outward\ninteraction','Ejection',\
                               'Inward\ninteraction','Sweep'],fontsize=fs-4)
        plt.savefig('vol_SHAPvol_'+colormap+'_30+.png')
    ...
    def plot_shaps_pdf(self,colormap='viridis',bin_num=100,lev_val=2.5,alf=0.5):
        ...
        plt.xlim([0,3])
        plt.ylim([0,7])
        plt.savefig('hist2d_interp_vol_SHAP_'+colormap+'_30+.png')
        xhistmin = np.min([np.min(self.volume_1),np.min(self.volume_2),np.min(self.volume_3),np.min(self.volume_4)])/1.2
        xhistmax = np.max([np.max(self.volume_1),np.max(self.volume_2),np.max(self.volume_3),np.max(self.volume_4)])*1.2
    ...
    def plot_shaps_pdf_probability(self,colormap='viridis',bin_num=100,lev_val=2.5,alf=0.5):
        ...
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_vol_SHAP_'+colormap+'_30+_Q1.png')
        fig=plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_vol_SHAP_'+colormap+'_30+_Q2.png')
        fig=plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_vol_SHAP_'+colormap+'_30+_Q3.png')
        fig=plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_vol_SHAP_'+colormap+'_30+_Q4.png')
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_vol_SHAPvol_'+colormap+'_30+_Q1.png')
        fig=plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_vol_SHAPvol_'+colormap+'_30+_Q2.png')
        fig=plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_vol_SHAPvol_'+colormap+'_30+_Q3.png')
        fig=plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_vol_SHAPvol_'+colormap+'_30+_Q4.png')
    ...
    def plot_shaps_pdf_perclim(self,colormap='viridis',bin_num=100,per_val=0.1,per_val_vol=0.1,alf=0.5,log=False):
        ...
        plt.contourf(vol_grid1,shap_grid1,histogram_Q1.T,levels=[lev_val1,1e5*lev_val1],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(vol_grid2,shap_grid2,histogram_Q2.T,levels=[lev_val2,1e5*lev_val2],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(vol_grid3,shap_grid3,histogram_Q3.T,levels=[lev_val3,1e5*lev_val3],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(vol_grid4,shap_grid4,histogram_Q4.T,levels=[lev_val4,1e5*lev_val4],colors=[(color41,color42,color43)],alpha=alf)
        ...
        plt.contourf(vol_grid_vol1,shap_grid_vol1,histogram_Q1_vol.T,levels=[lev_val1,1e5*lev_val1],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(vol_grid_vol3,shap_grid_vol3,histogram_Q3_vol.T,levels=[lev_val3,1e5*lev_val3],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(vol_grid_vol2,shap_grid_vol2,histogram_Q2_vol.T,levels=[lev_val2,1e5*lev_val2],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(vol_grid_vol4,shap_grid_vol4,histogram_Q4_vol.T,levels=[lev_val4,1e5*lev_val4],colors=[(color41,color42,color43)],alpha=alf)
    ...
    def plot_shaps_pdf_wall_perclim(self,colormap='viridis',bin_num=100,per_val=0.1,per_val_vol=0.1,alf=0.5,log=True):
        ...
        plt.contourf(vol_grid1_wa,shap_grid1_wa,histogram_Q1_wa.T,levels=[lev_val1_wa,1e5*lev_val1_wa],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(vol_grid2_wa,shap_grid2_wa,histogram_Q2_wa.T,levels=[lev_val2_wa,1e5*lev_val2_wa],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(vol_grid3_wa,shap_grid3_wa,histogram_Q3_wa.T,levels=[lev_val3_wa,1e5*lev_val3_wa],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(vol_grid4_wa,shap_grid4_wa,histogram_Q4_wa.T,levels=[lev_val4_wa,1e5*lev_val4_wa],colors=[(color41,color42,color43)],alpha=alf)
        ...
        plt.contourf(vol_grid1_wd,shap_grid1_wd,histogram_Q1_wd.T,levels=[lev_val1_wd,1e5*lev_val1_wd],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(vol_grid2_wd,shap_grid2_wd,histogram_Q2_wd.T,levels=[lev_val2_wd,1e5*lev_val2_wd],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(vol_grid3_wd,shap_grid3_wd,histogram_Q3_wd.T,levels=[lev_val3_wd,1e5*lev_val3_wd],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(vol_grid4_wd,shap_grid4_wd,histogram_Q4_wd.T,levels=[lev_val4_wd,1e5*lev_val4_wd],colors=[(color41,color42,color43)],alpha=alf)
        ...
        plt.contourf(vol_grid_vol1_wa,shap_grid_vol1_wa,histogram_Q1_vol_wa.T,levels=[lev_val1_wa,1e5*lev_val1_wa],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(vol_grid_vol3_wa,shap_grid_vol3_wa,histogram_Q3_vol_wa.T,levels=[lev_val3_wa,1e5*lev_val3_wa],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(vol_grid_vol2_wa,shap_grid_vol2_wa,histogram_Q2_vol_wa.T,levels=[lev_val2_wa,1e5*lev_val2_wa],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(vol_grid_vol4_wa,shap_grid_vol4_wa,histogram_Q4_vol_wa.T,levels=[lev_val4_wa,1e5*lev_val4_wa],colors=[(color41,color42,color43)],alpha=alf)
        ...
        plt.contourf(vol_grid_vol1_wd,shap_grid_vol1_wd,histogram_Q1_vol_wd.T,levels=[lev_val1_wd,1e5*lev_val1_wd],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(vol_grid_vol3_wd,shap_grid_vol3_wd,histogram_Q3_vol_wd.T,levels=[lev_val3_wd,1e5*lev_val3_wd],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(vol_grid_vol2_wd,shap_grid_vol2_wd,histogram_Q2_vol_wd.T,levels=[lev_val2_wd,1e5*lev_val2_wd],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(vol_grid_vol4_wd,shap_grid_vol4_wd,histogram_Q4_vol_wd.T,levels=[lev_val4_wd,1e5*lev_val4_wd],colors=[(color41,color42,color43)],alpha=alf)
    ...
    def plot_shaps_uv(self,colormap='viridis'):
        ...
        cb.ax.set_yticklabels(['Outward\ninteraction','Ejection',\
                               'Inward\ninteraction','Sweep'],fontsize=fs-4)
        plt.savefig('uv_SHAP_'+colormap+'_30+.png')
        fig = plt.figure()
        ax = plt.axes()
...
#        plt.text(0.1, 10, 'C', fontsize = 20) 
        ...
        cb.ax.set_yticklabels(['Outward\ninteraction','Ejection',\
                               'Inward\ninteraction','Sweep'],fontsize=fs-4)
        plt.savefig('uvvol_SHAPvol_'+colormap+'_30+.png')
        fig = plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_yticklabels(['Outward\ninteraction','Ejection',\
                               'Inward\ninteraction','Sweep'],fontsize=fs-4)
        plt.savefig('uvvoluvoltot_SHAPvol_'+colormap+'_30+.png')
    ...
    def plot_shaps_uv_ejectionover(self,colormap='viridis'):
        ...
        cb.ax.set_yticklabels(['Outward\ninteraction','Ejection',\
                               'Inward\ninteraction','Sweep'],fontsize=fs-4)
        plt.savefig('uv_SHAPq2_'+colormap+'_30+.png')
        fig = plt.figure()
        cmap_fill = plt.cm.get_cmap('viridis', 10)
        x0 = 0
        x0b = 0.7
        ...
        cb.ax.set_yticklabels(['Outward\ninteraction','Ejection',\
                               'Inward\ninteraction','Sweep'],fontsize=fs-4)
        plt.savefig('uvvol_SHAPvolq2_'+colormap+'_30+.png')
        fig = plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_yticklabels(['Outward\ninteraction','Ejection',\
                               'Inward\ninteraction','Sweep'],fontsize=fs-4)
        plt.savefig('uvvoluvoltot_SHAPvolq2_'+colormap+'_30+.png')
...
#        ax.clabel(c4, inline=True, fontsize=fs)
        ...
        plt.legend(handles,labels,fontsize=fs-4,loc='center left', bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
        plt.savefig('hist2d_uvuvtot_SHAP_'+colormap+'_30+.png')
...
#        ax.clabel(c4, inline=True, fontsize=fs)
        ...
        plt.legend(handles,labels,fontsize=fs-4,loc='center left', bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
        plt.savefig('hist2d_uvuvtotvol_SHAPvol_'+colormap+'_30+.png')
    ...
    def plot_shaps_uv_pdf_probability(self,colormap='viridis',bin_num=100,lev_val=2.5,alf=0.5):
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_uvuvtot_SHAP_'+colormap+'_30+_Q1.png')
        fig=plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_uvuvtot_SHAP_'+colormap+'_30+_Q2.png')
        fig=plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_uvuvtot_SHAP_'+colormap+'_30+_Q3.png')
        fig=plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_uvuvtot_SHAP_'+colormap+'_30+_Q4.png')
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_uvuvtotvol_SHAPvol_'+colormap+'_30+_Q1.png')
        fig=plt.figure()
        ax = plt.axes()
        plt.fill_between([x0,x1,x0b,x2],[y0_1,y1_1,y1_1,y1_1],[y0_2,y0_2,y0_2,y1_2],\
                         color=cmap_fill(0.9),alpha=0.1)
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_uvuvtotvol_SHAPvol_'+colormap+'_30+_Q2.png')
        fig=plt.figure()
        ax = plt.axes()
        plt.fill_between([x0,x1,x0b,x2],[y0_1,y1_1,y1_1,y1_1],[y0_2,y0_2,y0_2,y1_2],\
                         color=cmap_fill(0.9),alpha=0.1)
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_uvuvtotvol_SHAPvol_'+colormap+'_30+_Q3.png')
        fig=plt.figure()
        ax = plt.axes()
        plt.fill_between([x0,x1,x0b,x2],[y0_1,y1_1,y1_1,y1_1],[y0_2,y0_2,y0_2,y1_2],\
                         color=cmap_fill(0.9),alpha=0.1)
        ...
        cb.ax.set_ylabel('$N/N_{tot}$',fontsize=fs)
        plt.tick_params(axis='both', which='major', labelsize=fs)
        plt.savefig('hist2d_interp_uvuvtotvol_SHAPvol_'+colormap+'_30+_Q4.png')
    ...
    def plot_shaps_uv_pdf_perclim(self,colormap='viridis',bin_num=100,per_val=0.1,per_val_vol=0.1,alf=0.5,log=True):
        ...
        if log:
            ...
            lev_val3 = np.max([per_val*np.max(histogram_Q3),1])
            lev_val4 = np.max([per_val*np.max(histogram_Q4),1])
        plt.contourf(uv_grid1,shap_grid1,histogram_Q1.T,levels=[lev_val1,1e5*lev_val1],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(uv_grid2,shap_grid2,histogram_Q2.T,levels=[lev_val2,1e5*lev_val2],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(uv_grid3,shap_grid3,histogram_Q3.T,levels=[lev_val3,1e5*lev_val3],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(uv_grid4,shap_grid4,histogram_Q4.T,levels=[lev_val4,1e5*lev_val4],colors=[(color41,color42,color43)],alpha=alf)
        ...
        if log:
            ...
            lev_val4 = np.max([per_val_vol*np.max(histogram_Q4_vol),1])
        print(lev_val1)
        plt.contourf(uv_grid_vol1,shap_grid_vol1,histogram_Q1_vol.T,levels=[lev_val1,1e5*lev_val1],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(uv_grid_vol2,shap_grid_vol2,histogram_Q2_vol.T,levels=[lev_val2,1e5*lev_val2],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(uv_grid_vol3,shap_grid_vol3,histogram_Q3_vol.T,levels=[lev_val3,1e5*lev_val3],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(uv_grid_vol4,shap_grid_vol4,histogram_Q4_vol.T,levels=[lev_val4,1e5*lev_val4],colors=[(color41,color42,color43)],alpha=alf)
    ...
    def plot_shaps_uv_pdf_wall(self,colormap='viridis',bin_num=100,lev_val=2.5,alf=0.5):
        ...
        plt.legend(handles,labels,fontsize=fs-4,loc='center left', bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
        plt.savefig('hist2d_interp_uvuvtot_SHAP_'+colormap+'_30+_wall.png')
        ...
        plt.legend(handles,labels,fontsize=fs-4,loc='center left', bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
        plt.savefig('hist2d_interp_uvuvtot_SHAP_'+colormap+'_30+_wallattach.png')
        ...
        plt.legend(handles,labels,fontsize=fs-4,loc='center left', bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
        plt.savefig('hist2d_interp_uvuvtot_SHAP_'+colormap+'_30+_walldetach.png')
        ...
        plt.legend(handles,labels,fontsize=fs-4,loc='center left', bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
        plt.savefig('hist2d_interp_uvuvtotvol_SHAPvol_'+colormap+'_30+_wall.png')
        ...
        plt.legend(handles,labels,fontsize=fs-4,loc='center left', bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
        plt.savefig('hist2d_interp_uvuvtotvol_SHAPvol_'+colormap+'_30+_wallattach.png')
        ...
        plt.legend(handles,labels,fontsize=fs-4,loc='center left', bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
        plt.savefig('hist2d_interp_uvuvtotvol_SHAPvol_'+colormap+'_30+_walldettach.png')
    ...
    def plot_shaps_uv_pdf_wall_perclim(self,colormap='viridis',bin_num=100,per_val=0.1,per_val_vol=0.1,alf=0.5,log=False):
        ...
        if log:
            ...
            lev_val3_wd = np.max([per_val*np.max(histogram_Q3_wd),1])
            lev_val4_wd = np.max([per_val*np.max(histogram_Q4_wd),1])
        plt.contourf(uv_grid1_wa,shap_grid1_wa,histogram_Q1_wa.T,levels=[lev_val1_wa,1e5*lev_val1_wa],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(uv_grid2_wa,shap_grid2_wa,histogram_Q2_wa.T,levels=[lev_val2_wa,1e5*lev_val2_wa],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(uv_grid3_wa,shap_grid3_wa,histogram_Q3_wa.T,levels=[lev_val3_wa,1e5*lev_val3_wa],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(uv_grid4_wa,shap_grid4_wa,histogram_Q4_wa.T,levels=[lev_val4_wa,1e5*lev_val4_wa],colors=[(color41,color42,color43)],alpha=alf)
        ...
        plt.contourf(uv_grid1_wd,shap_grid1_wd,histogram_Q1_wd.T,levels=[lev_val1_wd,1e5*lev_val1_wd],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(uv_grid2_wd,shap_grid2_wd,histogram_Q2_wd.T,levels=[lev_val2_wd,1e5*lev_val2_wd],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(uv_grid3_wd,shap_grid3_wd,histogram_Q3_wd.T,levels=[lev_val3_wd,1e5*lev_val3_wd],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(uv_grid4_wd,shap_grid4_wd,histogram_Q4_wd.T,levels=[lev_val4_wd,1e5*lev_val4_wd],colors=[(color41,color42,color43)],alpha=alf)
        ...
        plt.contourf(uv_grid1_vol_wa,shap_grid1_vol_wa,histogram_Q1_vol_wa.T,levels=[lev_val1_wa,1e5*lev_val1_wa],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(uv_grid2_vol_wa,shap_grid2_vol_wa,histogram_Q2_vol_wa.T,levels=[lev_val2_wa,1e5*lev_val2_wa],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(uv_grid3_vol_wa,shap_grid3_vol_wa,histogram_Q3_vol_wa.T,levels=[lev_val3_wa,1e5*lev_val3_wa],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(uv_grid4_vol_wa,shap_grid4_vol_wa,histogram_Q4_vol_wa.T,levels=[lev_val4_wa,1e5*lev_val4_wa],colors=[(color41,color42,color43)],alpha=alf)
        ...
        plt.contourf(uv_grid1_vol_wd,shap_grid1_vol_wd,histogram_Q1_vol_wd.T,levels=[lev_val1_wd,1e5*lev_val1_wd],colors=[(color11,color12,color13)],alpha=alf)
        plt.contourf(uv_grid2_vol_wd,shap_grid2_vol_wd,histogram_Q2_vol_wd.T,levels=[lev_val2_wd,1e5*lev_val2_wd],colors=[(color21,color22,color23)],alpha=alf)
        plt.contourf(uv_grid3_vol_wd,shap_grid3_vol_wd,histogram_Q3_vol_wd.T,levels=[lev_val3_wd,1e5*lev_val3_wd],colors=[(color31,color32,color33)],alpha=alf)
        plt.contourf(uv_grid4_vol_wd,shap_grid4_vol_wd,histogram_Q4_vol_wd.T,levels=[lev_val4_wd,1e5*lev_val4_wd],colors=[(color41,color42,color43)],alpha=alf)
    ...
    def plot_shaps_kde(self,colormap='viridis',fit_bw=False):
        ...
        ax.grid() 
        plt.savefig('kde_SHAP_'+colormap+'_30+.png')
        # New figure
        ...
        plt.legend(fontsize=20, bbox_to_anchor=(1, 1))
        ax.grid()
        plt.savefig('kde_SHAPvol_'+colormap+'_30+.png')  
        # New figure
        ...
        plt.legend(fontsize=20, bbox_to_anchor=(1, 1))
        ax.grid() 
        plt.savefig('kde_SHAPjoin_'+colormap+'_30+.png')
        # New figure
        ...
        plt.legend(fontsize=20, bbox_to_anchor=(1, 1))
        ax.grid()  
        plt.savefig('kde_SHAPvoljoin_'+colormap+'_30+.png')
    ...
    def plot_shaps_AR(self,colormap='viridis'):
        ...
        shapmax = np.max([np.nanmax(self.SHAP_grid1),np.nanmax(self.SHAP_grid2),\
                          np.nanmax(self.SHAP_grid3),np.nanmax(self.SHAP_grid4)])
        ...
        shapmaxvol = np.max([np.nanmax(self.SHAP_grid1vol),np.nanmax(self.SHAP_grid2vol),\
                             np.nanmax(self.SHAP_grid3vol),np.nanmax(self.SHAP_grid4vol)])
        fs = 20
        fig = plt.figure()
        ax = plt.axes()
        ...
        plt.tick_params(axis='both',which='major',labelsize=fs)
        plt.savefig('AR_SHAP1_'+colormap+'_30+.png')
        fig = plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel(self.clabel_shap,fontsize=fs)
        plt.tick_params(axis='both',which='major',labelsize=fs)
        plt.savefig('AR_SHAP2_'+colormap+'_30+.png')
        fig = plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel(self.clabel_shap,fontsize=fs) 
        plt.tick_params(axis='both',which='major',labelsize=fs)
        plt.savefig('AR_SHAP3_'+colormap+'_30+.png')
        fig = plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel(self.clabel_shap,fontsize=fs)
        plt.tick_params(axis='both',which='major',labelsize=fs) 
        plt.savefig('AR_SHAP4_'+colormap+'_30+.png')  
        fig = plt.figure()
        ax = plt.axes()
        ...
        plt.tick_params(axis='both',which='major',labelsize=fs)
        plt.savefig('AR_SHAPvol1_'+colormap+'_30+.png')
        fig = plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel(self.clabel_shap_vol,fontsize=fs)
        plt.tick_params(axis='both',which='major',labelsize=fs)
        plt.savefig('AR_SHAPvol2_'+colormap+'_30+.png')
        fig = plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel(self.clabel_shap_vol,fontsize=fs) 
        plt.tick_params(axis='both',which='major',labelsize=fs)
        plt.savefig('AR_SHAPvol3_'+colormap+'_30+.png')
        fig = plt.figure()
        ax = plt.axes()
        ...
        cb.ax.set_ylabel(self.clabel_shap_vol,fontsize=fs)  
        plt.tick_params(axis='both',which='major',labelsize=fs) 
        plt.savefig('AR_SHAPvol4_'+colormap+'_30+.png')
    ...
    def plot_shaps_total(self,colormap='viridis'):
        ...
        ax.grid()  
        plt.savefig('bar_SHAP_'+colormap+'_30+.png')
...
#        structure
#        """
#        shap_sum = self.shap1cum+self.shap2cum+self.shap3cum+self.shap4cum+self.shapbcum
#        shap_vol_sum = self.shap_vol1cum+self.shap_vol2cum+self.shap_vol3cum+self.shap_vol4cum+self.shap_volbcum
#        self.shap1cum /= shap_sum
#        self.shap2cum /= shap_sum
#        self.shap3cum /= shap_sum
#        self.shap4cum /= shap_sum
#        self.shapbcum /= shap_sum
#        self.shap_vol1cum /= shap_vol_sum
#        self.shap_vol2cum /= shap_vol_sum
#        self.shap_vol3cum /= shap_vol_sum
#        self.shap_vol4cum /= shap_vol_sum
#        self.shap_volbcum /= shap_vol_sum
#        import matplotlib.pyplot as plt
#        fs = 20
#        plt.figure()
#        ax = plt.axes()
#        plt.bar([0.5,1.5],[self.shap1cum,self.shap_vol1cum],\
#                color=plt.cm.get_cmap(colormap,4).colors[0,:],\
#                label='Outward\ninteraction',edgecolor='black')
#        plt.bar([0.5,1.5],[self.shap2cum,self.shap_vol2cum],bottom=[self.shap1cum,self.shap_vol1cum],\
#                color=plt.cm.get_cmap(colormap,4).colors[1,:],\
#                label='Ejection',edgecolor='black')
#        plt.bar([0.5,1.5],[self.shap3cum,self.shap_vol3cum],\
#                bottom=[self.shap1cum+self.shap2cum,self.shap_vol1cum+self.shap_vol2cum],\
#                color=plt.cm.get_cmap(colormap,4).colors[2,:],\
#                label='Inward\ninteraction',edgecolor='black')
#        plt.bar([0.5,1.5],[self.shap4cum,self.shap_vol4cum],bottom=[self.shap1cum+self.shap2cum+self.shap3cum,\
#                self.shap_vol1cum+self.shap_vol2cum+self.shap_vol3cum],\
#                color=plt.cm.get_cmap(colormap,4).colors[3,:],\
#                label='Sweeps',edgecolor='black')
#        plt.bar([0.5,1.5],[self.shapbcum,self.shap_volbcum],bottom=[self.shap1cum+self.shap2cum+self.shap3cum+self.shap4cum,\
#                self.shap_vol1cum+self.shap_vol2cum+self.shap_vol3cum+self.shap_vol4cum],edgecolor='black',\
#                label='Background',fill=False)
#        ax.set_ylabel('Fraction of the total',fontsize=fs)
#        plt.tick_params(axis='both', which='major', labelsize=fs)   
#        ax.set_position([0.2,0.2,0.35,0.65]) 
...
#        plt.savefig('bar_SHAP_'+colormap+'_30+.png')
#        file_save = open('bar_SHAP.txt', "w+") 
#        file_save.write('SHAP percentage: \nOutward Int. '+str(self.shap1cum)+\
#                        '\nEjections '+str(self.shap2cum)+'\nInward Int. '+str(self.shap3cum)+\
#                        '\nSweeps '+str(self.shap4cum)+'\n')
#        file_save.write('SHAP per volume percentage: \nOutward Int. '+\
#                        str(self.shap_vol1cum)+'\nEjections '+str(self.shap_vol2cum)+\
#                        '\nInward Int. '+str(self.shap_vol3cum)+'\nSweeps '+\
#                        str(self.shap_vol4cum)+'\n')
#        file_save.close()
#            
#            
#          
#    def plot_shaps_total_noback(self,colormap='viridis'):
#        """
#        Function for calculating the SHAP contribution of each kind of 
#        structure
#        """
#        shap_sum = self.shap1cum+self.shap2cum+self.shap3cum+self.shap4cum
#        shap_vol_sum = self.shap_vol1cum+self.shap_vol2cum+self.shap_vol3cum+self.shap_vol4cum
#        self.shap1cum /= shap_sum
#        self.shap2cum /= shap_sum
#        self.shap3cum /= shap_sum
#        self.shap4cum /= shap_sum
