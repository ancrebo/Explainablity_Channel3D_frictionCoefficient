...
class shap_conf():
    ...
    def plot_shaps_pdf(self,
        ...
        fs = 20
        plt.figure()
        cud_colors = np.array(3*['#440154', '#009E73', '#F0E442', '#0072B2', '#E69F00'], dtype=object).reshape((3,5)).transpose()
        if colormap == 'custom':
        ...
        plt.contourf(vol_grid,shap_grid,histogram_Q2.T,levels=[lev_val,1e5*lev_val],colors=[('#440154','#440154','#440154')],alpha=alf)
