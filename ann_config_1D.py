...
#        print('Using Keras version: ', tf.keras.__version__)
    ...
    def load_ANN(self,filename='trained_model.h5'):
        """ 
...
#        print('Using Keras version: ', tf.keras.__version__)
    ...
    def saverms(self,file="Urmspred.txt"):
        """
    ...
    def readrms(self,file="Urmspred.txt"):
        """
    ...
    def savemre(self,file="mre_predic.txt"):
        """
        Function for saving the value of the rms velocity
        """
        file_save = open(file, "w+")           
